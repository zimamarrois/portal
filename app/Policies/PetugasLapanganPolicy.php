...
class PetugasLapanganPolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\PetugasLapangan  $petugasLapangan
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, PetugasLapangan $petugasLapangan)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, PetugasLapangan $petugasLapangan)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, PetugasLapangan $petugasLapangan)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, PetugasLapangan $petugasLapangan)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, PetugasLapangan $petugasLapangan)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, PetugasLapangan $petugasLapangan)
    {
